      ...
      <>
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView contentInsetAdjustmentBehavior="automatic">
            ...
            >
              <Text style={styles.toggleButtonText}>Show Original Demo</Text>
            </TouchableOpacity>
          </ScrollView>
        </SafeAreaView>
      </>
      ...
      >
        ...
        >
          <View style={styles.section}>
            ...
            >
              <Text style={styles.toggleButtonText}>Show Design System Demo</Text>
            </TouchableOpacity>
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx run-many -p RevomatApp -t build test lint
                </Text>
              </View>
