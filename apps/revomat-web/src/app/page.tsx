  ...
  return (
    ...
    <div className="wrapper">
      <div className="container">
        <div id="welcome" style={{ marginBottom: theme.spacing.xl }}>
          <Typography variant="h1" align="center">
            Welcome to Revomat Web 👋
          </Typography>
          <Typography variant="body1" align="center" color="dark" style={{ marginTop: theme.spacing.md }}>
            This is a Next.js application using the shared design system
          </Typography>
          <div style={{ display: 'flex', gap: theme.spacing.md, justifyContent: 'center', marginTop: theme.spacing.lg }}>
            ...
            <Button variant="outline" size="md" onClick={() => alert('Outline button clicked!')}>
              Outline Button
            </Button>
          </div>
        </div>
        ...
        <div id="commands" className="rounded shadow">
          ...
          <details>
            ...
            <pre>nx show project @revomat/revomat-web --web</pre>
          </details>
          <details>
            <summary>
              <svg
